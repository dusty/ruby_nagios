...
module OpenURI
  ...
  OPEN_TIMEOUT_DEFAULT = 10
  READ_TIMEOUT_DEFAULT = 20
  ...
  def OpenURI.open_http(buf, target, proxy, options) # :nodoc:
    ...
    http.open_timeout = options[:open_timeout] || OPEN_TIMEOUT_DEFAULT
    http.read_timeout = options[:read_timeout] || READ_TIMEOUT_DEFAULT
